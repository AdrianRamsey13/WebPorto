      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          {email ? (
            <a
              href={`mailto:${email}`}
              className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-primary text-primary-foreground text-sm font-medium hover:opacity-90 transition-opacity w-full sm:w-auto justify-center"
            >
            ...
            <p className="text-sm text-muted-foreground italic">Add your email via the admin panel.</p>
          )}
